...
def db_connect():
	...
	crsr.execute("""UPDATE matches SET poll_start_time = 1588797001, poll_message_id = 707690710090121266 WHERE channel_id = 707341589814444063""")
	conn.commit()
...
# poll_message_id NUMERIC(18) DEFAULT NULL
