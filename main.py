...
async def on_message(message):
	...
	if message.channel.category_id == config.MATCH_CATEGORY_ID:
		...
		if message_content.startswith('.testimage'):
			...
			draw_member1_name.text(((370 - w_1 + 258), 641), member1.display_name, fill='white', font=roboto_font)

			draw_member2_name = ImageDraw.Draw(match_frame_source)
			draw_member2_name.text((810, 641), member2.display_name, fill='white', font=roboto_font)
